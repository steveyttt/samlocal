...
function putitemdynamo(table, item, attribute) {
  ...
  //This populates the params var with a key called item & then the attribute value. You cannot natively assign a var as a key in an object
  ...
  //Use the above params to populate data inside the specified table
